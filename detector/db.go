...
import (
	...
	"gopkg.in/src-d/go-license-detector.v1/detector/internal/assets"
	"gopkg.in/src-d/go-license-detector.v1/detector/internal/normalize"
	"gopkg.in/src-d/go-license-detector.v1/detector/internal/wmh"
)
